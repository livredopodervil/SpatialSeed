...
require("apps/web/index.html", 'id="mesh-deform-live"')
require("packages/mesh-edit-panel/src/MeshEditPanel.js", '"mesh.deform.settings.set"')
require("packages/renderer-three/src/ThreeRegionRenderer.js", "transformLocalPositionsWithInfluenceInto")
