...
current=b.get("build")
if current not in {"20260813-0054mj", "20260813-0054mk", "20260813-0054ml", "20260817-0054mm", "20260817-0054mn", "20260817-0054mn1", "20260817-0054mo", "20260817-0054mp", "20260817-0054mq", "20260818-0054mr", "20260818-0054ms", "20260818-0054mt", "20260818-0054mu"}: errors.append(f"build incorreto: {current!r}")
if current in {"20260813-0054ml", "20260817-0054mm", "20260817-0054mn", "20260817-0054mn1", "20260817-0054mo", "20260817-0054mp", "20260817-0054mq", "20260818-0054mr", "20260818-0054ms", "20260818-0054mt", "20260818-0054mu"}:
 req("packages/character-animation-three/src/ThreeCharacterAnimationBackend.js", ("independent-visual-projection", 'fit: "none"'))
 runtime_version = "game-runtime-v7-independent-visual-facing" if current in {"20260818-0054mt", "20260818-0054mu"} else "game-runtime-v6-character-body-frame"
