import { EventBus } from "../../packages/core/src/EventBus.js?build=20260713-0019g-a";
import { Region } from "../../packages/core/src/Region.js?build=20260713-0019g-a";
import { Sandbox } from "../../packages/core/src/Sandbox.js?build=20260713-0019g-a";
import { ModuleRegistry } from "../../packages/plugin-api/src/ModuleRegistry.js?build=20260713-0019g-a";
import { EditorState } from "../../packages/editor-core/src/EditorState.js?build=20260713-0019g-a";
import { boxRegionReducer } from "../../packages/region-box/src/reducer.js?build=20260713-0019g-a";
import { ThreeRegionRenderer } from "../../packages/renderer-three/src/ThreeRegionRenderer.js?build=20260713-0019g-a";
import { OutlineRenderer } from "../../packages/renderer-outline/src/OutlineRenderer.js?build=20260713-0019g-a";
import { DevConsole } from "../../packages/devtools/src/DevConsole.js?build=20260713-0019g-a";
import { ObjectInspector } from "../../packages/object-inspector/src/ObjectInspector.js?build=20260713-0019g-a";
import { TransformToolPanel } from "../../packages/editor-transform-tools/src/TransformToolPanel.js?build=20260713-0019g-a";
import { SelectionOperations } from "../../packages/selection-operations/src/SelectionOperations.js?build=20260713-0019g-a";
import { createEditorCommands } from "../../packages/editor-commands/src/EditorCommands.js?build=20260713-0019g-a";
import { ProjectService } from "../../packages/project-files/src/ProjectService.js?build=20260713-0019g-a";
import { BenchmarkRunner } from "../../packages/benchmarks/src/BenchmarkRunner.js?build=20260713-0019g-a";
import { TestService } from "../../packages/tests/src/TestService.js?build=20260713-0019g-a";
import { activateRuntimeTestPlugin } from "../../packages/runtime-test-plugin/src/index.js?build=20260713-0019g-a";
import { AppearanceRuntime } from "../../packages/appearance-runtime/src/index.js?build=20260713-0019g-a";
import { classifyChanges } from "../../packages/incremental-runtime/src/index.js?build=20260713-0019g-a";
import { ResourceAudit } from "../../packages/resource-audit/src/index.js?build=20260713-0019g-a";

const BUILD = "20260713-0019g-a";
