import { EventBus } from "../../packages/core/src/EventBus.js?build=20260713-0019g-b1";
import { Region } from "../../packages/core/src/Region.js?build=20260713-0019g-b1";
import { Sandbox } from "../../packages/core/src/Sandbox.js?build=20260713-0019g-b1";
import { ModuleRegistry } from "../../packages/plugin-api/src/ModuleRegistry.js?build=20260713-0019g-b1";
import { EditorState } from "../../packages/editor-core/src/EditorState.js?build=20260713-0019g-b1";
import { boxRegionReducer } from "../../packages/region-box/src/reducer.js?build=20260713-0019g-b1";
import { ThreeRegionRenderer } from "../../packages/renderer-three/src/ThreeRegionRenderer.js?build=20260713-0019g-b1";
import { OutlineRenderer } from "../../packages/renderer-outline/src/OutlineRenderer.js?build=20260713-0019g-b1";
import { DevConsole } from "../../packages/devtools/src/DevConsole.js?build=20260713-0019g-b1";
import { ObjectInspector } from "../../packages/object-inspector/src/ObjectInspector.js?build=20260713-0019g-b1";
import { TransformToolPanel } from "../../packages/editor-transform-tools/src/TransformToolPanel.js?build=20260713-0019g-b1";
import { SelectionOperations } from "../../packages/selection-operations/src/SelectionOperations.js?build=20260713-0019g-b1";
import { createEditorCommands } from "../../packages/editor-commands/src/EditorCommands.js?build=20260713-0019g-b1";
import { ProjectService } from "../../packages/project-files/src/ProjectService.js?build=20260713-0019g-b1";
import { BenchmarkRunner } from "../../packages/benchmarks/src/BenchmarkRunner.js?build=20260713-0019g-b1";
import { TestService } from "../../packages/tests/src/TestService.js?build=20260713-0019g-b1";
import { activateRuntimeTestPlugin } from "../../packages/runtime-test-plugin/src/index.js?build=20260713-0019g-b1";
import { AppearanceRuntime } from "../../packages/appearance-runtime/src/index.js?build=20260713-0019g-b1";
import { classifyChanges } from "../../packages/incremental-runtime/src/index.js?build=20260713-0019g-b1";
import { ResourceAudit } from "../../packages/resource-audit/src/index.js?build=20260713-0019g-b1";

const BUILD = "20260713-0019g-b1";
